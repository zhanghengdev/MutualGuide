...
class REPVGGBackbone(nn.Module):
    ...
    def load_pre_trained_weights(self):
        ...
        pretrained_dict = {
            "repvgg-A0": "weights/TorchPretrained/RepVGG-A0-train.pth",
            "repvgg-A1": "weights/TorchPretrained/RepVGG-A1-train.pth",
            "repvgg-A2": "weights/TorchPretrained/RepVGG-A2-train.pth",
            "repvgg-B1": "weights/TorchPretrained/RepVGG-B1-train.pth",
            "repvgg-B2": "weights/TorchPretrained/RepVGG-B2-train.pth",
        }
