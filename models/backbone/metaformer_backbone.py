...
class PoolFormerBackbone(nn.Module):
    ...
    def load_pre_trained_weights(self):
        ...
        pretrained_dict = torch.load('weights/TorchPretrained/poolformer_s12.pth.tar')
        pretrained_dict.pop('norm.weight')
        pretrained_dict.pop('norm.bias')
        pretrained_dict.pop('head.weight')
        pretrained_dict.pop('head.bias')
