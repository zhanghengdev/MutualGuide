...
def create_act_layer(i, inplace=False):
    print(i)
    return nn.ReLU
...
class Inverted_Residual_Block(nn.Module):
    def __init__(
        self, num_in_channels, num_out_channels, kernel_size, stride, expansion
    ):
        super().__init__()
        self.drop_connect_rate = 0.0
        self.in_channels = num_in_channels
...
ckpts[
    "0"
] = "/home/heng/Documents/Projects/MutualGuide/weights/TorchPretrained/0.65ms.pth.tar"

configs = dict()
configs["0"] = [
    {"layer_type": "head", "num_in_channels": 3, "num_out_channels": 32},
    {
        "layer_type": "conv",
        "num_in_channels": 32,
        "num_out_channels": 32,
...
if __name__ == "__main__":
    a = GPUNet(configs["0"], ckpts["0"])
    print(a)
    b = torch.rand(2, 3, 640, 640)
    print(a(b).shape)
